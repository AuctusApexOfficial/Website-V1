                ...
                {currentPosts.map((post, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`group bg-white rounded-lg shadow-sm ${isWebDesignArticle || isSecondPosition || isAIMarketingArticle ? "hover:shadow-xl" : ""} transition-all duration-500 relative overflow-hidden flex flex-col h-full`}
                      onHoverStart={() =>
                    ...
                    >
                      ...
                      <div className="p-6 relative flex flex-col flex-grow">
                        ...
                        <p className="text-taupe-600 mb-4 flex-grow">{post.excerpt}</p>
