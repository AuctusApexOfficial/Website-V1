...
import { ArrowLeft, Calendar, Clock, User, Share2, PenTool, Layout, Palette } from "lucide-react"
...
export default function WebDesignArticlePage() {
      ...
      <div className="container mx-auto px-4 py-32">
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <motion.div
            ...
            className="prose prose-lg mx-auto mt-10 max-w-none prose-headings:font-serif prose-headings:text-taupe-900 prose-p:text-taupe-700 prose-a:text-gold-600 prose-a:no-underline hover:prose-a:text-gold-700"
          >
