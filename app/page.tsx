...
export default function Home() {
  ...
  useEffect(() => {
    // Simulate loading check for hero video
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              {[
                ...
                },
                {
                  ...
                  title: {
                    en: "Brand Identity",
                    it: "Identità di Marca",
                    es: "Identidad de Marca",
                  },
                  description: {
                    en: "Comprehensive branding solutions that establish a distinctive and memorable presence for your business.",
                    it: "Soluzioni di branding complete che stabiliscono una presenza distintiva e memorabile per la tua attività.",
                    es: "Soluciones integrales de marca que establecen una presencia distintiva y memorable para tu negocio.",
                  },
                  details: {
                    en: "Our brand identity services include logo design, visual identity systems, brand guidelines, messaging frameworks, brand positioning, and marketing collateral. We help you create a cohesive brand that resonates with your target audience.",
                    it: "I nostri servizi di identità di marca includono design del logo, sistemi di identità visiva, linee guida del brand, framework di messaggistica, posizionamento del brand e materiale di marketing. Ti aiutiamo a creare un brand coeso che risuoni con il tuo pubblico target.",
                    es: "Nuestros servicios de identidad de marca incluyen diseño de logotipos, sistemas de identidad visual, directrices de marca, marcos de mensajería, posicionamiento de marca y material de marketing. Te ayudamos a crear una marca cohesiva que resuene con tu público objetivo.",
                  },
                },
                {
                      ...
                      {expandedService !== index && (
                        ...
                        >
                          <span className="text-gold-600 font-serif" style={{ fontFamily: "Times New Roman, serif" }}>
                            {language === "it" ? "Scopri di più" : language === "es" ? "Más información" : "Learn more"}
                          </span>
            ...
            <div className="grid items-center gap-12 md:grid-cols-2">
              <div className="relative">
                ...
                <div className="mb-4 inline-flex">
                  ...
                  <p className="ml-4 font-serif text-sm uppercase tracking-widest text-gold-700">
                    {language === "it"
                      ? "Perché Sceglierci"
                      : language === "es"
                        ? "Por Qué Elegirnos"
