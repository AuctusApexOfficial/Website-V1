...
import BotProtectedForm from "@/components/bot-protected-form"
    ...
    try {
      ...
      if (TESTING_MODE) {
        ...
        toast({
          ...
          description: "Thank you for contacting Auctus. We'll get back to you shortly.",
          variant: "default",
        })
      }
          ...
          <div className="grid gap-12 md:grid-cols-2">
            ...
            >
              ...
              {submitted ? (
                ...
                <BotProtectedForm onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@auctusapex.it" className="text-amber-700 hover:text-amber-800">
                      info@auctusapex.it
                    </a>
                    <p className="mt-1 text-gray-600">{t("contact.support")}</p>
                    <a href="mailto:support@auctusapex.it" className="text-amber-700 hover:text-amber-800">
                      support@auctusapex.it
                    </a>
                  </div>
                </div>
      ...
      <section className="bg-stone-100 py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 text-center">
            ...
            <a
              href="mailto:info@auctusapex.it?subject=I Have a Question About..."
