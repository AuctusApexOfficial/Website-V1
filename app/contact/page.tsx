...
const TESTING_MODE = true // Set to false when you verify your domain with Resend
                  ...
                  {TESTING_MODE && (
                    <div className="rounded-md bg-amber-50 p-4 border border-amber-200">
                      <p className="text-sm text-amber-800">
                        <strong>Preview Mode:</strong> This form is currently in testing mode. Form submissions will be
                        logged, but emails will only be sent to the developer's email address until domain verification
                        is complete.
                      </p>
                    </div>
                  )}
