...
const services = [
  {
    ...
    description: {
      en: "Cutting-edge AI solutions that automate processes, enhance productivity, and drive innovation for your business across all digital touchpoints.",
      it: "Soluzioni AI all'avanguardia che automatizzano i processi, migliorano la produttività e guidano l'innovazione per la tua attività su tutti i punti di contatto digitali.",
      es: "Soluciones de IA de vanguardia que automatizan procesos, mejoran la productividad e impulsan la innovación para tu negocio en todos los puntos de contacto digitales.",
    },
    features: [
      {
        en: "Custom AI model development",
        it: "Sviluppo di modelli AI personalizzati",
        es: "Desarrollo de modelos de IA personalizados",
      },
      {
        en: "Workflow automation",
        it: "Automazione del flusso di lavoro",
        es: "Automatización de flujos de trabajo",
      },
      {
        en: "Chatbot implementation",
        it: "Implementazione di chatbot",
        es: "Implementación de chatbots",
      },
      {
        en: "Data analysis automation",
        it: "Automazione dell'analisi dei dati",
        es: "Automatización de análisis de datos",
      },
      {
