...
export default function ImageReveal({
  ...
  // Determine aspect ratio or dimensions to reserve space
  const imageStyle: React.CSSProperties = {}

  if (width && height) {
    imageStyle.aspectRatio = `${width}/${height}`
  } else {
    // Default aspect ratio if dimensions aren't provided
    imageStyle.aspectRatio = "16/9"
  }

  return (
    <div ref={ref} className={`relative overflow-hidden ${className}`} style={imageStyle}>
      <motion.div
        initial="hidden"
