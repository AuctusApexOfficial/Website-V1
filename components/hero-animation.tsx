...
export default function HeroAnimation() {
  ...
  const videoUrl = useOptimizedVideo
    ? "https://res.cloudinary.com/din4iqtbu/video/upload/q_auto:low,f_auto,c_fill,w_960/v1742370300/ennljsgefrx8y9evxowb.mp4"
    : "https://res.cloudinary.com/din4iqtbu/video/upload/q_auto:good,f_auto,c_fill,w_1920/v1742370300/ennljsgefrx8y9evxowb.mp4"

  // Fallback video URL
  const fallbackUrl =
    "https://res.cloudinary.com/din4iqtbu/video/upload/q_auto,f_auto/v1742369501/inusggvyosy2p6bndvs8.mp4"
