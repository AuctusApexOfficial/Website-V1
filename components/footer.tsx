...
export default function Footer() {
  ...
  // Update the handleSubscribe function to actually submit the form data
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Thank you for subscribing to the Auctus Apex newsletter. You'll receive updates on our latest services and insights.",
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-400">
              {language === "it"
                ? "Eleviamo i brand attraverso strategie di marketing sofisticate e soluzioni di web design su misura."
                : language === "es"
                  ? "Elevando marcas a través de estrategias de marketing sofisticadas y soluciones de diseño web a medida."
                  : t("footer.about")}
            </p>
          </div>
            ...
            {subscriptionSuccess ? (
              ...
              <form onSubmit={handleSubscribe} className="mt-4 space-y-3">
                <div className="flex">
                  ...
                  <Button
                    type="submit"
                    className="rounded-l-none bg-amber-700 hover:bg-amber-800"
