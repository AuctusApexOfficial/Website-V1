  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto flex items-center justify-between px-4">
        ...
        >
          <span
            className={`font-serif text-2xl font-bold ml-10 md:ml-12 lg:ml-14 ${scrolled ? "text-gold-600" : "text-white"}`}
          >
            <span className={scrolled ? "text-gold-600" : "text-gold-300"}>Auctus</span> Apex
          </span>
          ...
          {navItems.map((item) => (
            <Link
              ...
              className={`font-serif text-sm tracking-wide transition-colors hover:text-gold-500 ${
                scrolled ? "text-taupe-700" : "text-white"
              }`}
              onClick={(e) => {
