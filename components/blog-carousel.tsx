    ...
    <div className="relative">
      ...
      <div className="mx-auto overflow-hidden" style={{ width: `${(350 + 32) * 3}px` }}>
        ...
        <div
          ...
          onTouchStart={(e) => {
            setIsDragging(true)
            setStartX(e.touches[0].pageX - (carousel.current?.offsetLeft || 0))
            setScrollLeft(carousel.current?.scrollLeft || 0)
          }}
          onTouchMove={(e) => {
            if (!isDragging) return
            const x = e.touches[0].pageX - (carousel.current?.offsetLeft || 0)
        ...
        >
          <div
            className="flex gap-8 w-max transition-transform duration-500 ease-in-out infinite-carousel"
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center mb-3">
                    ...
                    {hasWebDesignPost && post.title === "The Importance of Web Design" && (
